...
rans_lrg = []
for i in range(18):
    file_elgS = '/global/cfs/cdirs/desi/vac/edr/lss/v2.0/LSScats/clustering/ELG_HIPnotqso_S_'+str(i)+'_clustering.ran.fits'
    file_elgN = '/global/cfs/cdirs/desi/vac/edr/lss/v2.0/LSScats/clustering/ELG_HIPnotqso_N_'+str(i)+'_clustering.ran.fits'
...
result = TwoPointCorrelationFunction('rppi', edges, data_positions1=lrgpos, data_weights1=data_weights,
                                    ...
                                    R1D2_weight_type="product_individual",R1R2_weight_type="product_individual",
                                    D1R2_weight_type="product_individual",estimator='landyszalay')
result.save("corrfunc/SV3_LRGs_rppi_1")
...
result = TwoPointCorrelationFunction('rppi', edges, data_positions1=elgpos, data_weights1=data_weights,
                                    ...
                                    R1D2_weight_type="product_individual",R1R2_weight_type="product_individual",
                                    D1R2_weight_type="product_individual",estimator='landyszalay')
result.save("corrfunc/SV3_ELGs_rppi_1")
...
for i in range(20):
    ...
    data_weights = np.repeat(1,len(lrgros))
    #weightlrg = len(lrgpos)/len(randpos)
    randoms_weights = np.repeat(weightlrg,len(randlrgros))
    result = TwoPointCorrelationFunction('rppi', edges, data_positions1=lrgpos, data_weights1=data_weights,
                                         randoms_positions1=randpos, randoms_weights1=randoms_weights,
                                         engine='corrfunc',position_type='rdd',D1D2_weight_type="product_individual",
                                        R1D2_weight_type="product_individual",R1R2_weight_type="product_individual",
                                        D1R2_weight_type="product_individual",estimator='landyszalay')
    result.save("corrfunc/SV3_LRGs_rppi_ros_1"+str(i))
    ...
    data_weights = np.repeat(1,len(elgros))
    #weightelg = len(elgpos)/len(randpos)
    randoms_weights = np.repeat(weightelg,len(randelgros))
    result = TwoPointCorrelationFunction('rppi', edges, data_positions1=elgpos, data_weights1=data_weights,
                                         randoms_positions1=randpos, randoms_weights1=randoms_weights,
                                         engine='corrfunc',position_type='rdd',D1D2_weight_type="product_individual",
                                        R1D2_weight_type="product_individual",R1R2_weight_type="product_individual",
                                        D1R2_weight_type="product_individual",estimator='landyszalay')
    result.save("corrfunc/SV3_ELGs_rppi_ros_1"+str(i))
